            ...
            RowLayout {
                ...
                KpiPanel {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Text { text: "vs PyTorch FP32 " + config.ptBaselineMs.toFixed(1) + " ms"; color: theme.bodyDim; font.pixelSize: 12 }
                            Item { Layout.fillWidth: true }
                ...
                KpiPanel {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            Layout.fillWidth: true
                            Text { text: kpiData.optMode + " vs PyTorch FP32 (" + kpiData.yoloModel + " · " + config.ptBaselineMs.toFixed(1) + " ms)"; color: theme.bodyDim; font.pixelSize: 12 }
                            Item { Layout.fillWidth: true }
